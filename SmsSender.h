...
signals:
    ...
    void sigSmsSent(int msgId, bool success);
    void sigSmsDelivered(int msgId, bool success);

public:
    ~SmsSender();

    Q_INVOKABLE int sendText(const QString &destMobile, const QString &msg);
...
private:
    ...
    void _dispPopupOnPhone(const QString &txt);
